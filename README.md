...
**[Hello_Microverse_Project]** is my first project in the Microverse Fullstack program. It's majorly about set-up, how to optimize the use of github flow and setting up linters in the right way.
